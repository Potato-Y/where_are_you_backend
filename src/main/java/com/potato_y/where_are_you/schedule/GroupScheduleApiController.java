...
public class GroupScheduleApiController {
  ...
  public ResponseEntity<GroupScheduleResponse> modifyGroupSchedule(@PathVariable Long groupId,
      @PathVariable Long scheduleId, @Validated @RequestBody CreateGroupScheduleRequest request) {
    GroupScheduleResponse response = groupScheduleService.modifyGroupSchedule(groupId, scheduleId,
        request);
